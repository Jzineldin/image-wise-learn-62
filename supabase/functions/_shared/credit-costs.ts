/**
 * SINGLE SOURCE OF TRUTH FOR CREDIT COSTS (Backend Copy)
 * This is a copy of the root shared/credit-costs.ts for edge function deployment
 * 
 * ⚠️ IMPORTANT: Keep this in sync with /shared/credit-costs.ts
 */
