...
-- ============================================
-- Issue: Featured stories are showing AI prompts instead of user-friendly descriptions
-- Solution: Return NULL for description if it looks like a prompt, and let the UI handle it
-- ============================================
...
BEGIN
  ...
  SELECT
    ...
    CASE
      ...
      WHEN LENGTH(s.description) > 200 THEN NULL  -- Prompts tend to be long
      ELSE s.description
    END as description,
...
-- Add comment
COMMENT ON FUNCTION "public"."get_featured_stories" IS 'Returns featured stories for public display, filtering out AI prompts from description field';
